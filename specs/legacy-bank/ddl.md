Here is a comprehensive PostgreSQL DDL (Data Definition Language) script designed to mimic a **Bank**.

This schema includes:
1.  **UUIDs** for secure primary keys.
2.  **Enums** for strict status control.
3.  **Audit timestamps** (`created_at`, `updated_at`) which are essential in banking.
...
CREATE TABLE customers (
    ...
    customer_number VARCHAR(20) UNIQUE NOT NULL, -- Human-readable ID (e.g., 8839201)
...
CREATE INDEX idx_customers_customer ON customers(customer_number);
...
-- Insert a Customer
INSERT INTO customers (customer_number, first_name, last_name, email, date_of_birth, kyc_status) 
VALUES ('1001', 'John', 'Doe', 'john.doe@example.com', '1985-05-20', 'VERIFIED');
...
FROM customers WHERE customer_number = '1001';
```