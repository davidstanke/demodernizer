...
## Output
Write the generated application to `generated_apps/{tag}_{spec_name}`, where "tag" is a unique 8-character tag derived from the selected tech stack, and "spec_name" is the name of the spec selected.
